...
<body>
    ...
    <div class="content">
        ...
        <div class="well">
        <a class="btn btn-primary" href="/index.php/Admin/Type/add.html">新增</a>
            <!-- table -->
            <table class="table table-bordered table-hover table-condensed">
                ...
                <tbody>
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr class="success">
                        ...
                        <td>
                            <a href="/index.php/Admin/Type/edit/id/<?php echo ($vol["type_id"]); ?>"> 编辑 </a>
                            <a href="javascript:void(0);" onclick="if(confirm('确认删除？')) location.href='/index.php/Admin/Type/del/id/<?php echo ($vol["type_id"]); ?>'"> 删除 </a>
                        </td>
