		...
		<div class="am-g take-delivery">
			<div class="am-u-sm-7 success">
				...
				<div class="goods">
					...
					<a href="/index.php/Home/Index/detail/id/<?php echo ($goods["id"]); ?>"><?php echo ($goods["goods_name"]); ?></a>
				</div>
			</div>
			<div class="am-u-sm-5 option">
				<a href="/index.php/Home/Index/detail/id/<?php echo ($goods["id"]); ?>"><img src="/Public/Home/images/backtogoods.png"></a>
				<a href="/index.php/Home/Cart/cart.html"><img src="/Public/Home/images/addtocart.png"></a>
			</div>
		</div>
