...
<body>
    ...
    <div class="sidebar-nav">
        ...
        <ul id="error-menu" class="nav nav-list collapse">
            <li><a href="/index.php/Admin/Manager/index.html">管理员列表</a></li>
            <li><a href="/index.php/Admin/Manager/add.html">管理员新增</a></li>
            <li><a href="javascript:void(0);">角色管理</a></li>
            <li><a href="javascript:void(0);">权限管理</a></li>
        </ul>
        <a href="#accounts-menu" class="nav-header" data-toggle="collapse"><i class="icon-exclamation-sign"></i>商品管理</a>
        <ul id="accounts-menu" class="nav nav-list collapse in">
            <li><a href="/index.php/Admin/Goods/index.html">商品列表</a></li>
            <li><a href="/index.php/Admin/Goods/add.html">商品新增</a></li>
