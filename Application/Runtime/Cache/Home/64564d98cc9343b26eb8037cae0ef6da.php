...
<html>
			...
			<div class="paycont">
				...
				<div class="logistics">
					...
					<ul class="op_express_delivery_hot">
						<li shipping_type="0" data-value="yuantong" class="OP_LOG_BTN  selected"><i class="c-gap-right" style="background-position:0px -468px"></i>圆通<span></span></li>
						<li shipping_type="1"data-value="shentong" class="OP_LOG_BTN  "><i class="c-gap-right" style="background-position:0px -1008px"></i>申通<span></span></li>
						<li shipping_type="2"data-value="yunda" class="OP_LOG_BTN  "><i class="c-gap-right" style="background-position:0px -576px"></i>韵达<span></span></li>
						<li shipping_type="3"data-value="zhongtong" class="OP_LOG_BTN op_express_delivery_hot_last "><i class="c-gap-right" style="background-position:0px -324px"></i>中通<span></span></li>
						<li shipping_type="4"data-value="shunfeng" class="OP_LOG_BTN  op_express_delivery_hot_bottom"><i class="c-gap-right" style="background-position:0px -180px"></i>顺丰<span></span></li>
					</ul>
				</div>
				<div class="clear"></div>
				...
				<div class="logistics">
					<h3>选择支付方式</h3>
					<ul class="pay-list">
						<li pay_type="0" class="pay card"><img src="/Public/Home/images/wangyin.jpg" />银联<span></span></li>
						<li pay_type="1" class="pay qq selected"><img src="/Public/Home/images/weizhifu.jpg" />微信<span></span></li>
						<li pay_type="2" class="pay taobao"><img src="/Public/Home/images/zhifubao.jpg" />支付宝<span></span></li>
					</ul>
				</div>
				<div class="clear"></div>
				...
				<div class="concent">
					<div id="payTable">
						...
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="clear"></div>
							...
							<div class="bundle  bundle-last">
								...
								<div class="bundle-main">
									<ul class="item-content clearfix">
											...
											<li class="td td-item">
												<div class="item-pic">
													<a href="#" class="J_MakePoint">
														<img src="<?php echo ($v["goods_logo"]); ?>" class="itempic J_ItemImg"></a>
												</div>
												<div class="item-info">
													<div class="item-basic-info">
														<a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11"><?php echo ($v["goods_name"]); ?></a>
													</div>
												</div>
											</li>
											<li class="td td-info">
											...
											<li class="td td-price">
												<div class="item-price price-promo-promo">
													<div class="price-content">
														<em class="J_Price price-now"><?php echo ($v["goods_price"]); ?></em>
													</div>
												</div>
											</li>
										</div>
										...
										<li class="td td-sum">
											<div class="td-inner">
												<em tabindex="0" class="J_ItemSum number"><?php echo ($v['number'] * $v['goods_price']); ?></em>
											</div>
										</li>
	...
	<form action="/index.php/Home/Cart/createorder" method="post" id="orderForm" style="display:none;">
...
<script type="text/javascript">
	$(function(){
		...
		$('#J_Go').click(function(){
			//准备请求参数
			//地址 address_id
			var address_id = $('li.defaultAddr').attr('address_id');
